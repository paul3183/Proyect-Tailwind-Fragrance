    ...
    <div className="bg-cream App h-screen px-4 py-7" >
        ...
        <div className='bg-white rounded-[10px] overflow-hidden'>
          ...
          <div className='h-[400px] p-5'>
            <h3 className='text-grayishblue text-[15px] tracking-[4px]'>PERFUME</h3>
            <h1 className='font-bold fran text-[32.2px] leading-[35px] mt-1'>Gabrielle Essence Eau De Parfum</h1>
            <p className='text-grayishblue montse text-[14.15px] leading-[22.5px] mt-3.5'>A floral, solar and voluptuous
            ...
            <div className='text-[12px] flex gap-[20px] mt-4 items-center'>
              <h2 className='text-darkcyan fran text-[33px]'>$149.99</h2><h3 className='montse text-grayishblue'>$169.99</h3>
            </div>
